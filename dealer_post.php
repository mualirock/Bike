...
session_start();
   ...
   if (isset($_POST['BtnSubmit'])=='Submit'){
       ...
       $insert=mysql_query("INSERT INTO `dealerbikes`(DealerId,BikeCategory,Brand, Model, Year, KilometreDriven, Transmission, FuelType, Stroke, EngineSize, Description, Details, Prize, DealerBikeImage1, DealerBikeImage2,DealerBikeImage3,DealerBikeImage4,WebSiteLink, Amount, UserName, ContactNumber, State, City, Location, PostalCode, Date ) VALUES ($DealerId,'$Brand','$Model','$Year',$KilometreDriven,'$Transmission','$FuelType','$Stroke','$EngineSize','$Description','$Details','$Prize','{$DealerBikeImage1}','{$DealerBikeImage2}','$WebSiteLink','{$DealerBikeImage3}','{$DealerBikeImage4}',$Amount ,'$UserName','$ContactNumber','$State','$City','$Location','$PostalCode','$Date')");
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="BikeCategory" id="category-group" class="form-control">
                                                ...
                                                <option value="Old Bikes"> Old Bikes</option>
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="Stroke" id="Select5" class="form-control">
                                                <option value="0" selected="selected"> Select Stroke Type...</option>
                                     ...
                                     <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="ContactNumber" id="Text5" placeholder="Phone number" value="<?php echo $res['MobileNumber'];?>">
