...
if(isset($_SESSION['usr_id'])) {
  header("Location: index.php");
   ...
   if (isset($_POST['BtnSubmit'])=='Submit'){
       ...
       $insert=mysql_query("INSERT INTO userregistration (UserName,MailId,PhoneNumber,State,City,Location,PostalCode,Password,ConfirmPassword,Date) VALUES ('$UserName','$MailId','$PhoneNumber','$State','$City','$Location','$PostalCode','$Password','$ConfirmPassword','$Date')");
   
   
       if($insert){
           ?>
<script>alert('Registered Successfully..');</script>
<script>window.open('UserLogin.php','_self')</script>;
<?php
   }
   else
   {
                              ...
                              <form class="form-horizontal" method="post" action="">
                                 ...
                                 <!-- Select Basic -->
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <!-- Text input-->
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="seller-Number">Location</label>
                                    <div class="col-sm-8">
                                 ...
                                 <!-- Text input-->
                                 <div class="form-group row">
                                    <label class="col-sm-3 col-form-label" for="seller-Number">Postal Code</label>
                                    <div class="col-sm-8">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-8"><!-- <a href="posting-success.html" id="button1id" name="BtnSubmit" 
