...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="assetsf/ico/apple-touch-icon-114-precomposed.png">
...
<div id="wrapper">
    <div class="themeControll ">
    	...
    	<h3 style=" color:#fff; font-size: 10px; line-height: 12px;" class="uppercase color-white text-center">
    		<a target="_blank" href="index.html">  All
    		Pages</a> </h3>
        ...
        <div class="dtable hw100">
            <div class="dtable-cell hw100">
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-sm-6 search-col relative locationicon">
                        ...
                        <div class="col-xl-3 col-sm-3 search-col relative">
                            <select id="autocomplete-ajax" class="form-control locinput input-rel searchtag-input has-icon" name="">
        ...
        <div class="container">
            ...
            <div class="col-xl-12 content-box ">
                <div class="row row-featured row-featured-category">
                    ...
                    <div class="col-xl-4 col-md-4 col-sm-4 col-xs-4 f-category">
                        <a href="category.html"><img src="images/category/sample_bike.jpg" class="img-responsive"
                    ...
                    <div class=" relative  content featured-list-row  w100">
                     ...
                     <span class="item-carousel-thumb">
                    	<img class="img-responsive" src="images/category/sample_bike.jpg" alt="img">
                                ...
                                <span class="item-name"> Bike Ad 1  </span>
                                <span class="price">  Rs.204,990 </span>
                            </a>
                            </div>
                     ...
                     <span class="item-carousel-thumb">
                    	<img class="img-responsive" src="images/category/sample_bike.jpg" alt="img">
                            ...
                            <div class="item"><a href="ads-details.html">
                                <span class="item-carousel-thumb"> <img class="item-img" src="images/category/sample_bike.jpg"
                                                                        alt="img"> </span> <span class="item-name"> Bike Ad 8 </span>
