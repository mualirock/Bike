                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav ml-auto navbar-right">
                        ...
                        <li class="dropdown no-arrow nav-item"><a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            ...
                            <span>Admin</span> <i class="icon-user fa"></i> <i class=" icon-down-open-big fa"></i></a>
                            <ul
                        ...
                        <li class="postadd nav-item"><a class="btn btn-block   btn-border btn-post btn-danger nav-link" href="Index.html"> Home </a>
                        </li>
                        <li class="postadd nav-item">            <h5 style="text-align:right "><img src="assets/img/n.jpg" width="50px" height="50px" /></h5>
</li>
...
<div class="container">
  ...
  <div class="jumbotron">
    ...
    <h4>Dealer Name  ...      
<center style="font-family :Forte;color:#000080;font-size :28px;">   Total post.</h4>
</center>  </div>
   ...
   <table class="table" style="background-color :white">
    ...
    <tbody>
      <?php
        $show=mysql_query("SELECT * FROM dealerbikes");
...
<div class="modal fade modalHasList" id="select-country" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title uppercase font-weight-bold" id="H1"><i class=" icon-map"></i> Select your region </h4>
