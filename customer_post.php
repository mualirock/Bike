                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" enctype="multipart/form-data" action="" method="post">
                                 ...
                                 <!--    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="KilometreDriven" class="form-control" id="Text7" placeholder="Kilometer Driven">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="Transmission" id="Select3" class="form-control">
                                                <option value="0" selected="selected"> Select Transmission...</option>
                                    ...
                                    <!-- <div class="form-group row">
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <span class="input-group-addon">Rs.</span>
                                                <input type="text" class="form-control" aria-label="Price" name="Prize">
                                            </div>
                                        </div>
                                 ...
                                 <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="ContactNumber" id="Text5" placeholder="Phone number" value="<?php echo $res['PhoneNumber'];?>">
