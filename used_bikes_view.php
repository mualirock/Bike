                    ...
                    <div class="inner inner-box ads-details-wrapper">
                        ...
                        <div class="ads-image">
                            ...
                            <ul class="bxslider">
                                ...
                                <li>
                                    <?php 
                                echo '<img alt="no img is found" src="data:image/jpeg;base64,'.base64_encode($res['UsedBikeImage2']).'"/>'
                                ?>
                                </li>
                                <li>
                                    <?php 
                                echo '<img alt="no img is found" src="data:image/jpeg;base64,'.base64_encode($res['UsedBikeImage3']).'"/>'
                                ?>
                                </li>
                            </ul>
                            <div id="bx-pager">
