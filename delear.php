<?php 
   ...
   if (isset($_POST['BtnSubmit'])=='Submit'){
       ...
       $CompanyMobileNumber=$_POST['CompanyMobileNumber'];
       $State=$_POST['State'];
       $City=$_POST['City'];
       ...
       $insert=mysql_query("INSERT INTO dealerregistration (DealerName,EmailID,MobileNumber,Password,ConfirmPassword,DealerType,CompanyName,CompanyEmail,CompanyMobileNum,State,City,Location,PostalCode,Date) VALUES ('$DealerName','$EmailID','$MobileNumber','$Password','$ConfirmPassword','$DealerType','$CompanyName','$CompanyEmail','$CompanyMobileNumber','$State','$City','$Location','$PostalCode','$Date')");
   
   
       if($insert){
           ?>
<script>alert('Registered Successfully..');</script>
<script>window.open('CompanyLogin.php','_self')</script>;
<?php
   }
   else
   {
                            ...
                            <div class="col-sm-12">
                                ...
                                <form class="form-horizontal" method="post" action="">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="textinput-name">Delear Name</label>
                                 ...
                                 <!-- Text input-->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Number">Mobile
                                            Number</label>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Number" >Password
                                             </label>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Number">Confirm Password
                                            </label>
                                    ...
                                    <hr />
                                      ...
                                      <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Location">Dealer Type</label>
                                 ...
                                 <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="textinput-name">Company Name</label>
                                    ...
                                    <!-- Appended checkbox -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-email"> Company Email
                                            </label>
                                    ...
                                    <!-- Text input-->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Number">Company Mob Number</label>
                                 ...
                                 <!-- Select Basic -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-state">State</label>
                                    ...
                                    <!-- Select Basic -->
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-Location">City</label>
                                     ...
                                     <!-- Text input-->
                                     <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-email"> Location
                                            </label>
                                     ...
                                     <div class="form-group row">
                                        <label class="col-sm-3 col-form-label" for="seller-email"> Postal Code
                                            </label>
